...
const create = async (params, credentials, auction) => {
    try {
        let response = await fetch(
            `${config.BACKEND_URL}/api/auctions/by/` + params.userId,
            {
                method: 'POST',
                headers: {
...
const listOpen = async (signal) => {
    try {
        let response = await fetch(`${config.BACKEND_URL}/api/auctions`, {
            method: 'GET',
            signal: signal,
        })
        return response.json()
...
const listByBidder = async (params, credentials, signal) => {
    try {
        let response = await fetch(
            `${config.BACKEND_URL}/api/auctions/bid/` + params.userId,
            {
                method: 'GET',
                signal: signal,
                headers: {
...
const read = async (params, signal) => {
    try {
        let response = await fetch(
            `${config.BACKEND_URL}/api/auction/` + params.auctionId,
            {
                method: 'GET',
                signal: signal,
            },
...
const update = async (params, credentials, auction) => {
    try {
        let response = await fetch(
            `${config.BACKEND_URL}/api/auctions/` + params.auctionId,
            {
                method: 'PUT',
                headers: {
                    Accept: 'application/json',
